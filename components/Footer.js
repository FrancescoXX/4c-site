...
const Footer = () => {
  return (
    <footer className="flex flex-col items-center p-4 py-8 text-center md:max-md: gap-4 bg-[#0d1117] text-white/80">
      ...
      <p className="text-xs font-medium md:max-md: text-white/80">
