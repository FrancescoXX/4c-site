          ...
          <div className="max-w-bodyContainer">
            <div className="my-[1rem] flex flex-wrap items-center justify-center gap-[1.5rem] pt-4 text-left md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
              {allProjects.projects.map((project) => (
                <div
                  key={project.name}
                  className="group flex w-[280px] shrink flex-col rounded-lg p-2 transition-all duration-200 ease-in-out hover:scale-110 transition duration-300 ease-in-out"
                >
