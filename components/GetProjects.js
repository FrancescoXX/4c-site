      ...
      <section className="flex-1 text-center text-white">
        ...
        <div className="flex items-center justify-center">
          <div className="max-w-bodyContainer">
            <div className="items-center justify-center pt-4 text-left my-[1rem] grid grid-flow-row gap-[1.5rem] md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-">
              {allProjects.projects.map((project) => (
                <div
                  key={project.name}
                  className="flex flex-col p-2 rounded-lg group w-[280px] shrink transition-all duration-200 ease-in-out"
                >
                  ...
                  <div className="flex flex-col w-full gap-[.2rem] justify-self-end rounded-br-xl rounded-bl-xl bg-[#f1f5f9] p-[20px]">
                    ...
                    <div className="flex items-center self-end w-full h-10 mt-auto bg-red my-[10px]">
                      <a
                        className="flex items-center px-4 mr-3 text-sm rounded-full gap-2 bg-[#1e293b] py-1.5 transition-all ease-in hover:bg-sky-700"
