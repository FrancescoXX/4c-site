          ...
          <div className="flex items-center justify-center ">
            <div className="break:w[500px] relative m-auto flex max-w-[800px] self-center mobile:mx-10 laptop:w-[600px] bigScreen:w-[800px]">
              <input
                ...
                className="h-10 w-full border-slate-200 px-5 py-3 text-black placeholder-slate-700 outline-none contrast-more:border-slate-400 contrast-more:placeholder-slate-500"
