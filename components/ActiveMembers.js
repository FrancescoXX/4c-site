        ...
        <div className="flex items-center justify-center ">
          <div className="break:w[500px] relative m-auto flex max-w-[800px] self-center bigScreen:w-[800px] laptop:w-[600px] mobile:mx-10">
            <input
              ...
              className="contrast-more:border-slate-400 contrast-more:placeholder-slate-500 h-10 w-full border-slate-200 px-5 py-3 text-black placeholder-slate-700 outline-none"
